...
def main():
    ...
    generate_and_save_embeddings(
        embedding_dir, embedder, asin_to_visual_attr, {}, {}, batch_size,
        modality='text', desc='Image attr', id2item=id2item, filename='image_attr'
    )

    # Fused text + image attribute embeddings
    generate_and_save_embeddings(
        embedding_dir, embedder, asin_to_text, asin_to_visual_attr, {}, batch_size,
        modality='text_with_text', desc='Text+Image attr', id2item=id2item, filename='text_with_image_attr'
    )
