...
python gme_qwen2vl.py --dataset=beauty --gpu_id=6 --embedding_encoder=gme-Qwen2-VL-2B-Instruct
python gme_qwen2vl.py --dataset=sports --gpu_id=7 --embedding_encoder=gme-Qwen2-VL-2B-Instruct
python gme_qwen2vl.py --dataset=toys --gpu_id=7 --embedding_encoder=gme-Qwen2-VL-2B-Instruct

# generate multimodal embeddings with GME Qwen2VL-7B-Instruct
python gme_qwen2vl.py --dataset=beauty --gpu_id=7 --embedding_encoder=gme-Qwen2-VL-7B-Instruct
python gme_qwen2vl.py --dataset=sports --gpu_id=7 --embedding_encoder=gme-Qwen2-VL-7B-Instruct
python gme_qwen2vl.py --dataset=toys --gpu_id=7 --embedding_encoder=gme-Qwen2-VL-7B-Instruct
