...
class LLMEmb_SASRec(SequentialRecommender):
    r"""
    ...
    def __init__(self, config, dataset):
        super(LLMEmb_SASRec, self).__init__(config, dataset)
    ...
    def reg_loss(self, target, user_emb):
        ...
        item_ids = torch.arange(self.n_items, device=user_emb.device)
        student_embs = self.item_embedding(item_ids)
